...
public class CourseEventsReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_COURSE_EVENT = "com.example.ief.notekeeperpluralsight.action.COURSE_EVENT";

    public static final String EXTRA_COURSE_ID =  "com.example.ief.notekeeperpluralsight.extra.COURSE_ID";
    public static final String EXTRA_COURSE_MESSAGE =  "com.example.ief.notekeeperpluralsight.extra.COURSE_MESSAGE";
